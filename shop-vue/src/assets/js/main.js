jQuery(
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(".mobile-menu__sidebar-menu .dropdown-list .menuarrow").on(
                "click",
                function () {
            ...
            $(".mobile-menu__sidebar-menu .dropdown .menuarrowtwo").on(
                "click",
                function () {
            ...
            if ($(".varients").length) {
                $(".varients li a").on("click", function () {
                    ...
                    var target_slider = $(
                        ".single-product-box .big-product"
            ...
            if ($(".products-grid-one__product-varient img").length) {
                $(".products-grid-one__product-varient img").on(
                    "click",
                    function () {
                        $(this)
                            .parent()
                            .parent()
                            .parent()
                            .find(".products-grid-one__hover-img")
            ...
            $(".slick").slick({
                prevArrow:
                    '<div class="slick-arrow arrow-back"> <i class="flaticon-left-arrow-2"></i> </div>',
                nextArrow:
                    '<div class="slick-arrow arrow-next"> <i class="flaticon-right-arrow-2"></i> </div>',
            });
            ...
            if ($(".hero-slider5").length) {
                $(".hero-slider5")
                    .slick({
                        ...
                        slidesToScroll: 1,
                        prevArrow:
                            '<div class="slick-arrow slick-prev"><i class="mi-chevron-left" aria-hidden="true"></i></div>',
                        nextArrow:
                            '<div class="slick-arrow slick-next"><i class="mi-chevron-right" aria-hidden="true"></i></div>',
                    })
            ...
            if ($(".product-cat-slider").length) {
                $(".product-cat-slider").slick({
                    ...
                    centerMode: true,
                    prevArrow:
                        '<div class="slick-arrow slick-prev"><i class="flaticon-left-arrow-1" aria-hidden="true"></i></div>',
                    nextArrow:
                        '<div class="slick-arrow slick-next"><i class="flaticon-next-1" aria-hidden="true"></i></div>',
                    responsive: [
                        {
                            breakpoint: 1024,
                            settings: {
            ...
            if ($(".reviewOneSlider").length) {
                $(".reviewOneSlider").slick({
                    ...
                    autoplay: true,
                    prevArrow:
                        '<button class="arrow-back"><i class="flaticon-back"></i> </button>',
                    nextArrow:
                        '<button class="arrow-next"><i class="flaticon-next"></i></button>',
                    autoplaySpeed: 2000,
                    pauseOnHover: false,
                    responsive: [
                        {
            ...
            if ($(".ftproductgr").length) {
                $(".ftproductgr").slick({
                    ...
                    autoplay: true,
                    prevArrow:
                        '<button class="arrow-back"> <img src="assets/images/home-six/arroe-left.png" alt=""></button>',
                    nextArrow:
                        '<button class="arrow-next"> <img src="assets/images/home-six/arroe-right.png" alt=""></button>',
                    autoplaySpeed: 2000,
                    pauseOnHover: false,
                    responsive: [
                        {
            ...
            if ($(".hero-slider").length) {
                $(".hero-slider").slick({
                    ...
                    autoplay: true,
                    prevArrow:
                        '<button class="arrow-back"><img src="assets/images/home-four/arrow-left.png" alt="images"> </button>',
                    nextArrow:
                        '<button class="arrow-next"> <img src="assets/images/home-four/arrow-right.png" alt="images"></button>',
                    autoplaySpeed: 2000,
                    pauseOnHover: false,
                    responsive: [
                        {
            ...
            $(".single-product-three").slick({
                ...
                autoplay: true,
                prevArrow:
                    '<button class="arrow-back"><i class="flaticon-left-arrow-1"></i> </button>',
                nextArrow:
                    '<button class="arrow-next"><i class="flaticon-next-1"></i></button>',
                autoplaySpeed: 4000,
                asNavFor: ".slider-nav",
                pauseOnHover: false,
            });

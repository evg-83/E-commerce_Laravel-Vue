  ...
  <div>
    ...
    <header class="header-style-3">
                ...
                <ul class="page-dropdown-menu">
                    ...
                    <ul class="dropdown">
                      <li class="subhed position-relative">
                        ...
                        <ul class="subdropdown">
                          <li>
                            <a href="shop-details-1.html">Shop Details 01</a>
                          </li>
                          <li>
                            <a href="shop-details-3.html">Shop Details 02</a>
                          </li>
                          <li>
                            <a href="shop-details-3.html">Shop Details 03</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                  ...
                  <li class="dropdown-list">
                    ...
                    <ul class="dropdown">
                      <li class="subhed position-relative">
                        ...
                        <ul class="subdropdown">
                          <li>
                            <a href="shop-grid.html">Latest Shoes</a>
                          </li>
                          <li>
                            <a href="shop-grid.html">New Shoes</a>
                          </li>
                          <li>
                            <a href="shop-grid.html">Casual Shoes</a>
                          </li>
                          <li>
                            <a href="shop-grid.html">Office Shoes</a>
                          </li>
                        </ul>
                      </li>
                      <li class="subhed position-relative">
                        ...
                        <ul class="subdropdown">
                          ...
                          <li>
                            <a href="shop-grid-left-sidebar.html">Shirts</a>
                          </li>
                          <li>
                            <a href="shop-grid-right-sidebar.html">Polos</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html">Jeans</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html"
                              >Casual Dress</a
                      ...
                      <li class="subhed position-relative">
                        ...
                        <ul class="subdropdown">
                          ...
                          <li>
                            <a href="shop-grid-left-sidebar.html">Quick Deal</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html"
                              >Shoes Items</a
                          ...
                          <li>
                            <a href="shop-grid-left-sidebar.html">Hot Deal</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html"
                              >Fast Services
                      ...
                      <li class="subhed position-relative">
                        ...
                        <ul class="subdropdown">
                          <li>
                            <a href="shop-grid-left-sidebar.html">10% Off</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html">20% Off</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html">30% Off</a>
                          </li>
                          <li>
                            <a href="shop-grid-left-sidebar.html">40% Off</a>
                          </li>
                          <li>
                            <a href="shop-list-left-sidebar.html">50% Off</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
                  ...
                  <li class="dropdown-list">
                    ...
                    <ul class="dropdown">
                      ...
                      <li>
                        <a href="order-track.html"> Order Track </a>
                      </li>
                      <li>
                          ...
                          >
                            <li class="dropdown-list">
                              ...
                              <ul class="dropdown">
                                <li>
                                  <a href="index.html"
                                    >Home Page 01
                                    <sup class="info three">Popular</sup></a
                                  >
                                </li>
                                <li>
                                  <a href="index-2.html"
                                    >Home Page 02
                                    <sup class="info one">Hot</sup></a
                                  >
                                </li>
                                <li>
                                  <a href="index-3.html">Home Page 03 </a>
                                ...
                                <li>
                                  <a href="index-5.html"
                                    >Home Page 05
                                    <sup class="info two">New</sup></a
                                  >
                                </li>
                                <li>
                                  <a href="index-6.html"
                                    >Home Page 06
                                    <sup class="info one">New</sup></a
                                  >
                                </li>
                                <li>
                                  <a href="index-7.html"
                                    >Home Page 07
                                    <sup class="info three">New</sup></a
                                  >
                                </li>
                              </ul>
                            </li>
                                  ...
                                  <ul class="submenu">
                                    <li>
                                      <a href="shop-details-1.html"
                                        >Shop Details Style 01</a
                                      >
                                    </li>
                                    <li>
                                      <a href="shop-details-2.html"
                                        >Shop Details Style 02</a
                                      >
                                    </li>
                                    <li>
                                      <a href="shop-details-3.html"
                                        >Shop Details Style 03</a
                                      >
                                    </li>
                                  </ul>
                                </li>
                            ...
                            <li class="dropdown-list megamenu">
                              ...
                              <div class="dropdown megamenu-dropdown">
                                <div class="row g-0">
                                  <div
                                    class="col-xl-6 col-lg-7 megamenu-padding-one"
                                  >
                                    <div class="row g-0">
                                      <div class="col-lg-4">
                            ...
                            <li class="dropdown-list">
                              ...
                              <ul class="dropdown">
                                ...
                                <li>
                                  <a href="order-track.html">Order_Track</a>
                                </li>
                                <li>
                                  <a href="my-account.html">My_Account</a>
                                </li>
                              </ul>
                            </li>
                            <li class="dropdown-list">
                    ...
                    >
                      <li class="dropdown-list">
                        ...
                        <ul class="dropdown">
                          ...
                          <li>
                            <a href="index-2.html"
                              >Home Page 02 <sup class="info one">Hot</sup></a
                            >
                          </li>
                          <li>
                            <a href="index-3.html">Home Page 03 </a>
                          ...
                          <li>
                            <a href="index-5.html"
                              >Home Page 05 <sup class="info two">New</sup></a
                            >
                          </li>
                          <li>
                            <a href="index-6.html"
                              >Home Page 06 <sup class="info one">New</sup></a
                            >
                          </li>
                          <li>
                            <a href="index-7.html"
                              >Home Page 07 <sup class="info three">New</sup></a
                            >
                          </li>
                        </ul>
                      </li>
                              ...
                              <div class="row g-0">
                                <div class="col-xl-6 col-lg-5">
                                  <div class="content">
                                    ...
                                    <a href="shop-details-1.html" class="price"
                                      >$250.00</a
                                    >
                                  </div>
                                </div>
                                  ...
                                  <div class="offer">
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        <a href="shop-grid-left-sidebar.html">
                                          <span>%</span>
                                          Get an Extra 20% Off Sale! Use Code:
                                          Sale
                                        </a>
                                      </li>
                                      <li>
      ...
      <div class="sidebar-content">
        <div class="sidebar-widget-container">
          <div
            class="widget-heading d-flex justify-content-end align-content-center"
          >
          ...
          <div class="sidebar-textwidget">
            <div class="sidebar-info-contents">
              <div class="content-inner">
                <div class="logo">
                  <a href="index.html"
                    ><img src="src/assets/images/logo/logo-2.png" alt=""
                  /></a>
                </div>
                ...
                <div class="sidebar-contact-info">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <a href="tel:+44203700001">+44 123 456 789</a>
                    </li>
                    <li>
        ...
        >
          ...
          <div class="slide">
            <div class="contant-box position-relative">
              <img
                ...
                src="src/assets/images/home-three/home-3-bg.jpg"
                alt="image"
              />
                ...
                <div class="container w-100 h-100">
                  ...
                  >
                    <div class="col-xl-6 col-md-9">
                      ...
                      >
                        <h6 class="new wow animated fadeInUp">
                          NEW COLLECTION
                        </h6>
                        ...
                        <p class="text wow animated fadeInUp">
                          ...
                          elit. Vehicula faucibus massa est elit maecenas.
                        </p>
                        <a
                          href="shop-grid.html"
          ...
          <div class="slide">
            <div class="contant-box position-relative">
              <img
                class="bg-img hundread-vh"
                src="src/assets/images/home-three/home-3-bg-2.jpg"
                alt="image"
              />
          ...
          <div class="row mt--30">
            <div class="col-lg-6 h-100 mt-30">
              <a href="shop-grid.html" class="catagory-single one home3cat">
                <img
                  src="src/assets/images/home-three/cat-1.png"
                  alt="#"
              ...
              <div class="row">
                <div class="co-12 mt-30">
                  <a href="shop-grid.html" class="catagory-single home3cat">
                    <img
                      src="src/assets/images/home-three/catbg-3.png"
                      alt=""
                ...
                <div class="col-12 mt-30">
                  <a href="shop-grid.html" class="catagory-single home3cat">
                    <img
                      src="src/assets/images/home-three/catbg-2.png"
                      alt=""
                      class="background-img bg-img"
                    />
                    <div class="content">
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        ...
                        <div class="products-grid-one__badge-box">
                          ...
                          <span class="bg_black badge discount">-40%</span>
                        </div>
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Apex Sneakers </a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Sports Shoes</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          ...
                          />
                          <img
                            src="src/assets/images/home-three/products-hover-3.png"
                            alt=""
                            class="hover-img"
                          />
                        </a>
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Trendy stylish shoes</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Casual Shoes</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Outdoor Sports Shoes</a>
                        </h5>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Sport Sneakers</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Brown Office Shoe</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          ...
                          />
                          <img
                            src="src/assets/images/home-three/productss2-hover-3.png"
                            alt=""
                            class="hover-img"
                          />
                        </a>
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Sport Shoe Lilo</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Black Office Shoe</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img
                            src="src/assets/images/home-three/productss2-5.jpg"
                            alt=""
                          />
                        </a>
                        <div class="products-grid-one__badge-box">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">Leather Sneakers</a>
                        </h5>
                        <p>$159.00</p>
                      </div>
                    </div>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      ...
                      <div class="products-three-single-content text-center">
                        <span>Men Shoes</span>
                        <h5>
                          <a href="shop-details-3.html">White Casual Shoe</a>
                        </h5>
                        <p><del>$200.00</del> $159.00</p>
                      </div>
                    </div>
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          ...
                          />
                          <img
                            src="src/assets/images/home-three/productss3-hover-1.jpg"
                            alt=""
                            class="hover-img"
                          />
                        </a>
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          ...
                          />
                          <img
                            src="src/assets/images/home-three/productss3-hover-3.png"
                            alt=""
                            class="hover-img"
                          />
                        </a>
                  ...
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img
                            src="src/assets/images/home-three/productss3-5.png"
                            alt=""
                          />
                        </a>
                        <div class="products-grid-one__badge-box">
            ...
            <div class="col-xl-6 wow fadeInLeft animated">
              <div class="video-main-box position-relative">
                <div
                  ...
                  style="
                    background-image: url(src/assets/images/home-three/video-v2-img1.jpg);
                  "
                >
                  <div
                ...
                <div class="video-two__content-inner">
                  ...
                  <div class="text wow fadeInUp animated">
                    <p>
                      ...
                      Dramatically network maout-of-the-box best practices
                      whereas effective intellectual capital.
                    </p>
                  </div>
                  <div class="btn-box wow fadeInUp animated">
                    <a href="shop-grid.html" class="btn--primary style2"
                      >Discover More</a
                    >
                  </div>
                </div>
                ...
                <ul>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid-one__badge-box">
                        <span class="bg_black badge discount">-70%</span>
                      </div>
                      <a href="cart.html" class="addcart btn--primary style2">
                        Add To Cart
                      </a>
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup6" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-content text-center">
                      <span>Men Shoes</span>
                      <h5>
                        <a href="shop-details-3.html">Exclusive Sneakers </a>
                      </h5>
                      <p>$159.00</p>
                    </div>
                  </li>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup7" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-content text-center">
                      <span>Men Shoes</span>
                      <h5>
                        <a href="shop-details-3.html">Fashionable Sneakers </a>
                      </h5>
                      <p><del>$200.00</del> $159.00</p>
                    </div>
                  </li>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup8" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-content text-center">
                      <span>Men Shoes</span>
                      <h5>
                        <a href="shop-details-3.html">Summer Shoes</a>
                      </h5>
                      <p>$159.00</p>
                    </div>
                  </li>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img">
                      <a href="shop-details-3.html" class="d-block">
                        ...
                        />
                        <img
                          src="src/assets/images/home-three/productss2-hover-5.png"
                          alt=""
                          class="hover-img"
                        />
                      </a>
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup9" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup1" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup2" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-img">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup3" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                  ...
                  <li class="products-three-single wow fadeInUp animated">
                    <div class="products-three-single-img img-bg">
                      ...
                      <div class="products-grid__usefull-links">
                        <ul>
                          ...
                          <li>
                            <a href="#popup4" class="popup_link">
                              <i class="flaticon-visibility"></i>
                              <span> quick view</span>
                            </a>
                          </li>
                    ...
                    <div class="products-three-single-content text-center">
                      <span>Men Shoes</span>
                      <h5>
                        <a href="shop-details-3.html">High Quality Sneakers</a>
                      </h5>
                      <p>$159.00</p>
                    </div>
                  </li>
              ...
              <div class="col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single">
                  <div
                    ...
                    style="
                      background-image: url(src/assets/images/shop/products-v7-img1.jpg);
                    "
                  ></div>
                  <div class="products-cetagory-three__single-content">
                    ...
                    <div class="btn-box">
                      <a href="shop-grid-left-sidebar.html">Explore Items</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xxl-3 col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single height-400 style2">
                  <div class="inner h-100">
                    ...
                    <div class="btn-box">
                      <a href="cart.html" class="button">Code: LOVEBITE</a>
                    </div>
              ...
              <div class="col-xxl-3 col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single style3">
                  <div
                    class="products-cetagory-three__single-img height-400"
                    style="
                      background-image: url(src/assets/images/shop/products-v7-img2.jpg);
                    "
                  ></div>
                  <div class="products-cetagory-three__single-content">
                    <span>Puma Hot Deal</span>
                    ...
                    <div class="btn-box">
                      <a href="shop-list-right-sidebar.html">Explore Items</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-6">
              ...
              >
                <div class="thumb">
                  <img src="src/assets/images/home-two/envalop.png" alt="" />
                </div>
                ...
                <form action="#0" class="form">
                  <div class="newsLetter-one__subscribe-box">
                    <input
                      ...
                      name="email"
                    />
                    <button type="submit" class="subscrib-btn">
                      Subscribe
                    </button>
                  </div>
                </form>
              ...
              >
                <div class="col-xl-4 col-md-7">
                  ...
                  >
                    ...
                    <p>
                      Continually enhance long-term don high impact niche
                      markets whereas user centric niche markets. actualize
                      backward compatible...
                    </p>
                    <div class="btn-box">
                      <a
                    ...
                    <div class="col-lg-4 col-sm-6">
                      ...
                      >
                        <div class="categories-three__list-item-inner">
                          ...
                          >
                            <img
                              src="src/assets/images/home-three/categories-v2-img1.jpg"
                              alt=""
                            />
                            <div class="text">
                              <span>369 Items</span>
                      ...
                      >
                        <div class="categories-three__list-item-inner">
                          <a href="shop-grid-left-sidebar.html" class="img-box">
                            <img
                              src="src/assets/images/home-three/categories-v2-img2.jpg"
                              alt=""
                            />
                            <div class="text">
                              <span>369 Items</span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                      ...
                      >
                        <div class="categories-three__list-item-inner">
                          <a href="shop-grid-left-sidebar.html" class="img-box">
                            <img
                              src="src/assets/images/home-three/categories-v2-img3.jpg"
                              alt=""
                            />
                            <div class="text">
                              <span>369 Items</span>
          ...
          <div class="row mt--30">
            ...
            >
              <div class="core-features__box d-flex ms-0">
                ...
                <span class="two"></span>
                <div class="icon">
                  <img src="src/assets/images/icon/f-icon-1.png" alt="" />
                </div>
                <div class="core-features__box-content">
                  ...
                  <p>
                    Everybody different which the why give offer styles for
                    every body.
                  </p>
                </div>
              </div>
            ...
            >
              <div class="core-features__box d-flex">
                ...
                <span class="two"></span>
                <div class="icon">
                  <img src="src/assets/images/icon/f-icon-2.png" alt="" />
                </div>
                <div class="core-features__box-content">
                  <a href="login.html" class="d-block">
            ...
            >
              <div class="core-features__box d-flex">
                ...
                <span class="two"></span>
                <div class="icon">
                  <img src="src/assets/images/icon/f-icon-3.png" alt="" />
                </div>
                <div class="core-features__box-content">
                  <a href="login.html" class="d-block">
                    <h4>Return & Refund</h4>
            ...
            >
              <div class="core-features__box d-flex me-0">
                ...
                <span class="two"></span>
                <div class="icon">
                  <img src="src/assets/images/icon/f-icon-4.png" alt="" />
                </div>
                <div class="core-features__box-content">
                  <a href="login.html" class="d-block">
                ...
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb">
                        <img
                          src="src/assets/images/testimonial/testimonial-v1-1.png"
                          alt=""
                        />
                      </div>
                      <span class="quate">
                    ...
                    <div class="review-one__review-text">
                      <p>
                        “Quickly explot worldwide leadership long-term
                        high-impact "outside the box thinking. Quickly network
                        synergistic enterprise customer service”
                      </p>
                      <h4>
                        <a href="#0">Ana Fleming </a>
                      </h4>
                ...
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb">
                        <img
                          src="src/assets/images/testimonial/testimonial-v1-2.png"
                          alt=""
                        />
                      </div>
                      <span class="quate">
                ...
                <div class="review-one__single-review">
                  <div class="review-one__single-content">
                    <div class="review-one__aurthor">
                      <div class="thumb">
                        <img
                          src="src/assets/images/testimonial/testimonial-v1-3.png"
                          alt=""
                        />
                      </div>
                      <span class="quate">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30">
                <a
                  ...
                  class="blog-three__single-img d-block"
                >
                  <img src="src/assets/images/blog/blog-v3-2.jpg" alt="" />
                </a>
                <div class="blog-three__single-content text-center">
                  <span>Vendora Style</span>
                  <h4>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
              <div class="blog-three__single mt-30">
                <a
                  ...
                  class="blog-three__single-img d-block"
                >
                  <img src="src/assets/images/blog/blog-v3-3.jpg" alt="" />
                </a>
                <div class="blog-three__single-content text-center">
                  <span>Vendora Style</span>
                  <h4>
          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="gallery-two__slider">
                <a
                  href="src/assets/images/home-three/gallery-v2-img1.jpg"
                ...
                <a
                  href="src/assets/images/home-three/gallery-v2-img2.jpg"
                  class="gallery-two__single"
                >
                  <img
                    src="src/assets/images/home-three/gallery-v2-img2.jpg"
                    alt=""
                  />
                  <span class="zoom-icon">
                    <i class="flaticon-expand"></i>
                ...
                <a
                  href="src/assets/images/home-three/gallery-v2-img3.jpg"
                  class="gallery-two__single"
                >
                  <img
                    src="src/assets/images/home-three/gallery-v2-img3.jpg"
                    alt=""
                  />
                  <span class="zoom-icon">
                    <i class="flaticon-expand"></i>
                ...
                <a
                  href="src/assets/images/home-three/gallery-v2-img4.jpg"
                  class="gallery-two__single"
                >
                  <img
                    src="src/assets/images/home-three/gallery-v2-img4.jpg"
                    alt=""
                  />
                  <span class="zoom-icon">
                    <i class="flaticon-expand"></i>
                ...
                <a
                  href="src/assets/images/home-three/gallery-v2-img5.jpg"
                  class="gallery-two__single"
                >
                  <img
                    src="src/assets/images/home-three/gallery-v2-img5.jpg"
                    alt=""
                  />
                  <span class="zoom-icon">
                    <i class="flaticon-expand"></i>
                ...
                <a
                  href="src/assets/images/home-three/gallery-v2-img6.jpg"
                  class="gallery-two__single"
                >
                  <img
                    src="src/assets/images/home-three/gallery-v2-img6.jpg"
                    alt=""
                  />
                  <span class="zoom-icon">
                    <i class="flaticon-expand"></i>
    ...
    <footer class="footer-default footer-3">
      <div class="footer-default__shap_1 position-absolute">
        <img src="src/assets/images/shape/footer-shape-1.png" alt="" />
      </div>
      <!--Start Footer-->
            ...
            >
              <div class="footer-default__single-box">
                <div class="company-info">
                  ...
                  <div class="text2">
                    <p>
                      68 Jay Street, Suite 902 New Side
                      <br />
                      Brooklyn, NY 11201
                    </p>
                  </div>
        ...
        <div class="container">
          <div class="footer_bottom_content">
            ...
            <div class="footer-payment wow fadeInUp animated">
              <a href="#0">
                <img
                  src="src/assets/images/home-four/method-1.jpg"
                  alt="payment"
                />
              </a>
              <a href="#0">
                <img
                  src="src/assets/images/home-four/method-2.jpg"
                  alt="payment"
                />
              </a>
              <a href="#0">
                <img
                  src="src/assets/images/home-four/method-3.jpg"
                  alt="payment"
                />
              </a>
              <a href="#0">
                <img
                  src="src/assets/images/home-four/method-4.jpg"
                  alt="payment"
                />
              </a>
            </div>

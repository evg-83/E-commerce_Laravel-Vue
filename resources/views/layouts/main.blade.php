...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div
      ...
      <p class="animation__shake" src="" alt="" height="60"
        width="60">Shop</p>
    </div>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; GruCodeholic.co: 2022-{{ now()->year }}. <a
          href="{{ route('main.index') }}">Gru's shop</a>. </strong>
      All rights reserved.
  ...
  <!-- Bootstrap 4 -->
  <script
    src="{{ asset('adminlte/plugins/bootstrap/js/bootstrap.bundle.min.js') }}">
  </script>
  <!-- overlayScrollbars -->
  <script
